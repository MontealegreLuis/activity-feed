...
final class ActivityLoggerTest {
  @Test
  void it_cannot_be_created_without_a_logger() {
    assertThrows(IllegalArgumentException.class, () -> new ActivityLogger(null));
  }
  ...
  void let() {
    ...
    feed = new ActivityLogger(logger);
  }

  private ActivityLogger feed;
